...
class AICoverProcessor:
    ...
    def process_cover(self, guide_path: str, model_name: str, song_request_id: str, index: int) -> bool:
        ...
        try:
            ...
            example = [f'/app/temp/songRequestId/[-1]1_reverb.mp3', f'/app/temp/songRequestId/[0]1_reverb.mp3', f'/app/temp/songRequestId/[1]1_reverb.mp3']

            # mr 파일 피치 변경
            mr_path = f'/app/temp/songRequestId/1_mr.mp3'
