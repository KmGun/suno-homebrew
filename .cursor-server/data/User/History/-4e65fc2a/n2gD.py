...
async def separate_audio_tracks(input_file_path, song_request_id, file_number):
    ...
    separator1.separate(temp_file_path, model_file_dir='/app/models/Kim_Vocal_1.onnx')
    time.sleep(2)
    ...
    separator2.separate(vocals_path, model_file_dir='/app/models/6_HP-Karaoke-UVR.pth')
    time.sleep(2)
    ...
    separator3.separate(karaoke_vocals_path, model_file_dir='/app/models/Reverb_HQ_By_FoxJoy.onnx')
    time.sleep(2)
    ...
    separator4.separate(reverb_path, model_file_dir='/app/models/UVR-DeNoise.pth')
    time.sleep(2)
