    ...
    async def separate_audio_tracks(self, input_file_path, song_request_id, file_number):
        ...
        for model_name, stage_name in stages:
            ...
            if stage_name == "Denoising":
                ...
                current_input = f"{temp_dir}/temp_{identifier}_(Vocals)_Kim_Vocal_1_(Vocals)_6_HP-Karaoke-UVR_(Instrumental)_Reverb_HQ_By_FoxJoy.mp3"
            ...
            if stage_name == "Kim Vocal 1 separation":
                current_input = f"{temp_dir}/temp_{identifier}_(Vocals)_Kim_Vocal_1.mp3"
            elif stage_name == "6HP-Karaoke separation":
                current_input = f"{temp_dir}/temp_{identifier}_(Vocals)_Kim_Vocal_1_(Vocals)_6_HP-Karaoke-UVR.mp3"
        ...
        result_paths = {
            'mr': os.path.join(temp_dir, f"temp_{identifier}_mr.mp3"),
            'chorus': os.path.join(temp_dir, f"temp_{identifier}_corus.mp3"),
            'vocal': os.path.join(temp_dir, f"temp_{identifier}_vocal.mp3")
        }
        
        print("\n=== Copying final results ===")
        print("Source files:")
        source_files = [
            f"{temp_dir}/temp_{identifier}_(Instrumental)_Kim_Vocal_1.mp3",
            f"{temp_dir}/temp_{identifier}_(Vocals)_Kim_Vocal_1_(Instrumental)_6_HP-Karaoke-UVR.mp3",
            f"{temp_dir}/temp_{identifier}_(Vocals)_Kim_Vocal_1_(Vocals)_6_HP-Karaoke-UVR_(Instrumental)_Reverb_HQ_By_FoxJoy_(Instrumental)_UVR-DeNoise.mp3"
        ]
